...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.0, 312.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 113.25, 19.0, 50.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.60717, 114.0, 27.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.821415, 153.0, 68.303589, 17.0 ],
					"style" : "",
					"text" : "(0V / 10V)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 561.0, 450.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.780663, 100.0, 44.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 822.5, 692.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.613846, 175.0, 10.77126, 10.472361 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 75.428589, 172.5, 27.0, 17.0 ],
					"style" : "",
					"text" : "Trig",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 686.0, 692.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 18.405661, 73.292229, 106.75, 20.0 ],
					"style" : "",
					"textcolor" : [ 0.278431, 0.839216, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 18.405661, 51.0, 106.75, 20.0 ],
					"style" : "",
					"textcolor" : [ 0.278431, 0.839216, 1.0, 1.0 ],
					"varname" : "Triggering"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 375.5, 335.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "ddg.mono 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 122.071411, 172.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 132.035751, 172.0, 29.0, 17.0 ],
					"style" : "",
					"text" : "Mod",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 106.732162, 172.0, 24.0, 17.0 ],
					"style" : "",
					"text" : "Vel",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 44.125, 172.0, 31.0, 17.0 ],
					"style" : "",
					"text" : "Gate",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.821415, 172.0, 37.0, 17.0 ],
					"style" : "",
					"text" : "1v/oct",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 529.5, 692.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 256.5, 705.0, 113.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 67.836136, 80.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 16.0, 115.25, 21.0 ],
					"style" : "",
					"text" : "MIDI TO SIGNAL",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -1.21934, 174.0, 170.0, 17.0 ],
					"proportion" : 0.39,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -1.21934, 0.0, 170.0, 17.0 ],
					"proportion" : 0.39,
					"prototypename" : "M4LBack",
					"rounded" : 0,
					"style" : ""
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -1.21934, 15.666667, 170.0, 19.333334 ],
					"proportion" : 0.39,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -1.21934, 0.0, 170.0, 191.0 ],
					"proportion" : 0.39,
					"prototypename" : "M4LTopMenuBar",
					"rounded" : 0,
					"style" : ""
...
, 			{
		...
		"parameters" : 		{
			"obj-20" : [ "ModWheelActivityLED[1]", "ModWheelActivityLED", 0 ],
			"obj-69" : [ "1voctled[1]", "1voctled", 0 ],
			"obj-28" : [ "Bend[1]", "Bend", 0 ]
		}
,
		"dependency_cache" : [  ],
		"autosave" : 0,
